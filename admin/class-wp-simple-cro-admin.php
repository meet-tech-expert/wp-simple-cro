...
class Wp_Simple_Cro_Admin {
	...
	public function enqueue_scripts() {
		wp_enqueue_script('simple-cro-chart-js', plugin_dir_url(__FILE__) . '/js/chart.js',array('jquery'), $this->version, true);
		wp_enqueue_script($this->plugin_name, plugin_dir_url(__FILE__) . 'js/wp-simple-cro-admin.js', array('jquery'), $this->version, true);
		wp_enqueue_script('simple-cro-gutenberg', plugin_dir_url(__FILE__) . 'js/simple-cro-admin.js', array('wp-blocks', 'wp-i18n', 'wp-element', 'wp-components', 'wp-editor'), $this->version, true);
